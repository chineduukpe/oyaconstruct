...
<div class="card-body text-muted">
  <h5 class="pb-3 mb-0 border-bottom border-danger">{{++$i}}. <a href='{{URL::to("admin/product/$store->id")}}'>{{ $store->ownername }} <span class="btn btn-sm {{$store->status === 0 ? 'btn-primary' : ($store->status === 1 ? 'btn-success' : 'btn-danger') }}"></span></a></h5>
