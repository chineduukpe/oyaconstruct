	...
	<div class="alert alert-danger">
		...
		<div class="card-deck">
			...
			<div class="card">
				<div class="card-body">
					...
					<form class="form-horizontal" method='post' action="{{route('vendor.update',$store->id)}}">
						...
						<div class="form-group">
							...
							<input type="email" id="email" name="owneremail" placeholder="mystore@domain.com"  required="required" autocomplete="off" class="form-control" value="{{$store->owneremail}}">
						</div>
						<div class="form-group">
				...
				<div class="form-group">
					<label class="control-label" for="">Set status as *</label>
