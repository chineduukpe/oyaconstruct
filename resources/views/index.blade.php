    ...
    <div id="">
      ...
      <div class="d-flex flex-column flex-md-row align-items-center p-2 bg-white box-shadow fixed-top">
        ...
        <nav class="my-2 my-md-0 mr-md-3">
          <a class="btn text-secondary" href="{{route('customer.cart.view')}}"> <i class="fa fa-cart-plus"></i> Cart
      ...
      <!-- END BECOME A VENDOR MODAL modal-->
      <!-- reset modal-->
          ...
          <div class="container mt-5 mb-4 text-center text-md-left">
            <div class="row mt-5">
              ...
              <div class="col-md-4 mx-auto mb-4 mt-5">
                ...
                <p><a href="#becomeAVendor" data-toggle="modal">Become a vendor</a></p>
