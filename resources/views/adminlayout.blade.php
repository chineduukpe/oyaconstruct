    ...
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        ...
        <div class="user-info">
          ...
          <span class="user-role">{{ ucwords(Session::get('role'))}}</span>
  ...
  <main class="page-content">
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white box-shadow">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        <a class="p-2 text-danger" href="{{URL::to('index')}}"><i class="fas fa-home"></i>Home</a>
         <a class="p-2 text-danger" href="{{URL::to('admin/home')}}"><i class="fas fa-tasks"></i>Dashboard</a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExample05">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="{{URL::to('admin/home')}}">Dashboard</a>
          </li>
